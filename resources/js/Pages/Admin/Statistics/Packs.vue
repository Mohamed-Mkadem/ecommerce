...
<template>
    <Head :title="$t('Offers statistics')" />
    <PageHeader :page-title="$t('Offers statistics')"> </PageHeader>
    ...
    <section class="my-12">
        ...
        <div v-if="bestSelling[currentBestSellingPeriod].length">
            ...
            >
                ...
                >
                    <div
                        class="flex items-center justify-between flex-wrap mb-3"
                    >
                        <p
