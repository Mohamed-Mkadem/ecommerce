...
<template>
    <Modal v-slot="{ close }" ref="modalRef" max-width="md"
        ...
        <form @submit.prevent="submitForm">
            ...
            <div class="mt-4 w-full">
                ...
                <select @change="locationSelector.getCities(form.state)" required v-model="form.state" id="state_id"
            ...
            <div class="mt-4 w-full">
                ...
                <select @change="locationSelector.getLocalities(form.city)" required v-model="form.city" id="city_id"
                    class="w-full mt-1 rounded-md focus:ring-primary focus:border-primary border-editor text-primary">
                    <option :value="null" class="capitalize">
                        {{ $t("Choose a city") }}
                    </option>
            ...
            <div class="mt-4 w-full">
                ...
                <select required v-model="form.locality" id="locality_id"
                    ...
                    <option :value="locality.id" v-for="locality in locationSelector.localities.value"
                        :key="locality.id">
                        {{ locality.name }}
                    </option>
                </select>
            ...
            <div class="mt-4">
                ...
                <TextInput class="mt-1 block w-full" id="address" type="text" v-model="form.address" :required="true"
            ...
            <div class="mt-4">
                ...
                <TextInput class="mt-1 block w-full" id="phone" v-model="form.phone" :required="false" type="number"
            ...
            <div class="mt-4">
                ...
                <TextInput class="mt-1 block w-full" id="phone" v-model="form.phone2" :required="false" type="number"
                    :placeholder="$t('8 digits phone number')" />
