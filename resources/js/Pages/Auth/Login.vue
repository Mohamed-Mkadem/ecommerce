...
import DefaultAuthCard from "@/js/Components/Auths/DefaultAuthCard.vue";
import InputGroup from "@/js/Components/Auths/InputGroup.vue";
...
<template>
    ...
    <DefaultAuthCard :title="$t('Login.welcome')">
        <form @submit.prevent="submit">
            ...
            <div class="mb-5 mt-6">
                <input
                    ...
                    :class="{
                        'bg-opacity-25 cursor-not-allowed pointer-events-none':
                            form.processing,
                    }"
                    type="submit"
                    :value="$t('Login')"
