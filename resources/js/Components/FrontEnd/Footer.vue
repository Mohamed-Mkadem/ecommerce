...
const infoLinks = [
  { text: "Nav.about", link: "FE.about" },
  { text: "Nav.contact", link: "FE.contact" },
  { text: "Nav.privacy", link: "FE.privacy" },
  { text: "Nav.terms", link: "FE.terms" },
];
</script>
...
<template>
  <footer class="bg-primary text-zinc-300">
    ...
    <div
      class="max-w-screen-xl mx-auto px-6 pt-14 pb-10 grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr]"
    >
      <!-- Brand column -->
      <div class="flex flex-col items-center lg:items-start gap-4">
        <AppLogo class="w-[160px]" />
        <p
      ...
      <div class="text-center lg:text-start">
        <h3 class="text-xs font-bold tracking-[0.2em] uppercase text-gold mb-6">
          {{ $t("Contact") }}
        </h3>
        <ul class="space-y-4">
          <li class="flex items-center justify-center lg:justify-start gap-3">
            <i class="ri-mail-line text-gold text-base flex-shrink-0"></i>
            <a
          ...
          <li
            v-for="p in phoneLinks"
            :key="p.link"
            class="flex items-center justify-center lg:justify-start gap-3"
          >
            <i class="ri-phone-line text-gold text-base flex-shrink-0"></i>
            <a
              :href="p.link"
              dir="ltr"
